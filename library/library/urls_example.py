...
# from library.view_example import BookViewSet
# from library.view_example import BookListAPIView
...
# from library.view_example import get
# from library.view_example import BookCustomViewSet
# from library.view_example import  BookListAPIView
from library.view_example import  BookLimitOffsetPaginatonViewSet
...
# from library.view_example import BookCreateAPIView,BookListAPIView,BookRetrieveAPIView,BookDestroyAPIView,BookListAPIView,BookUpdateAPIView
...
urlpatterns = [
    ...
    # filter part_2
    # path(/<str:name>/', BookListAPIView.as_view()),
    #
    # path('api/', include(router.urls)),
